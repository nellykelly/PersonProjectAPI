...
_PUBLIC_TOOL_NOTE = (
    ...
    "site's own live traffic analytics (get_traffic_summary). When someone "
    "asks to see the traffic/request-volume graph, call get_traffic_summary "
    "-- a chart renders automatically alongside your reply, so answer as if "
    "the visitor can see it rather than saying you can't show graphs. A tool call must "
